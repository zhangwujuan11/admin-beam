  ...
  <div class="app-container">
    <el-form inline :model="queryParams" label-width="68px" ref="queryForm" v-show="showSearch">
      <el-row>
        <el-col :span="6">
          <el-form-item>
            <el-date-picker v-model="value" type="daterange" range-separator="-" start-placeholder="选择张拉日期"
              end-placeholder="选择张拉日期">
            </el-date-picker>
          </el-form-item>
        </el-col>
        <el-col :span="3">
          <el-form-item>
            <el-input clearable placeholder="梁号/梁型/标段/位置" size="small" v-model="queryParams.number" />
          </el-form-item>
        </el-col>
        <el-col :span="3">
          <el-form-item>
    ...
    <el-table :data="methodSettingsList" v-loading="loading" border height="500"
      ...
      <el-table-column align="center" label="标段" prop="componentType" />
      <el-table-column align="center" label="梁号" prop="componentType" />
      <el-table-column align="center" label="梁型" prop="componentType" />
      <el-table-column align="center" label="张拉时间" prop="componentType" />
      <el-table-column align="center" label="工程部位" prop="componentType" />
      <el-table-column align="center" label="预警原因" prop="componentType" />
      <el-table-column align="center" label="状态" prop="constructionMethod" />
